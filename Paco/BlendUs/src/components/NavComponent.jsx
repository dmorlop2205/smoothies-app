    ...
    return (
        <nav>
            ...
            <div className={`menu ${menuOpen ? 'menu-open' : ''}`}>
                ...
                >
                    <svg width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M15 12H12M12 12H9M12 12V9M12 12V15M17 21H7C4.79086 21 3 19.2091 3 17V7C3 4.79086 4.79086 3 7 3H17C19.2091 3 21 4.79086 21 7V17C21 19.2091 19.2091 21 17 21Z" stroke="#6b7280" strokeWidth="2" strokeLinecap="round"/>
                    </svg>
                    Create
                </NavLink>
                <NavLink
                ...
                >
                    <svg width="800px" height="800px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path d="M20,21V19a4,4,0,0,0-4-4H8a4,4,0,0,0-4,4v2" fill="none" stroke="#6b7280" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"/>
                        <circle cx="12" cy="7" fill="none" r="4" stroke="#6b7280" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"/>
            ...
            <div className={`collapsed-menu ${menuOpen ? 'open' : ''}`} onClick={() => setMenuOpen(!menuOpen)}>
                    <span></span>
                    <span></span>
                    <span></span>
            </div>
