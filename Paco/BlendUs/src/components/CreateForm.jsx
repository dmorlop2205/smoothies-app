  ...
  return (
    <form className="form" encType='multipart/form-data'>
        <div className='image'>
            ...
            <h2>Add a photo of your smoothie</h2>
            <h3>Drag and drop</h3>
            <input type="file" />
        </div>
        ...
        <div className="category">
            ...
            {/* CAMBIAR A SELECT */}
            <input className="text-input" type="text" id="category" placeholder='Choose a category'/>
        </div>
        ...
        <div className="ingredients-container">
            <div className="ingredients-header">
                ...
                <div className="add-button">
                    <svg width="28px" height="28px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <line fill="none" stroke="#007A55" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" x1="12" x2="12" y1="19" y2="5"/>
                        <line fill="none" stroke="#007A55" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" x1="5" x2="19" y1="12" y2="12"/>
                    </svg>
                    <p>Add</p>
                </div>
            ...
            <div className="ingredients">
                <input className="text-input ingredient" type="text" id="ingredient" placeholder='Ingredient'/>
                <input className="text-input amount" type="text" id="amount" placeholder='Amount'/>
        ...
        <div className="tags-container">
            ...
            <div className="tags">
                <input className="text-input" type="text" id="tags" placeholder='Add a tag...'/>
