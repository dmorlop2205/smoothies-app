    ...
    <section className="post">
        <div className="post-header">
            ...
            <div className="post-options">
                <svg width="80px" height="80px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="7" cy="12" r="0.5" stroke="#99A1AF" strokeLinecap="round" strokeLinejoin="round"/>
                    <circle cx="12" cy="12" r="0.5" stroke="#99A1AF" strokeLinecap="round" strokeLinejoin="round"/>
                    <circle cx="17" cy="12" r="0.5" stroke="#99A1AF" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
            </div>
        </div>
        ...
        <div className="interactions">
            ...
            <div className="like-comment-share">
                <svg className="like" width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg className="comment" viewBox="0 0 32 32" fill="none">
                    <path 
                ...
                <svg className="share" xmlns="http://www.w3.org/2000/svg" height="48px" viewBox="0 -960 960 960" width="48px" fill="#364153">
        ...
        <div className="description">
            <p>
                ...
                <span className="expand-description">
                    <svg className="expand" xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#364153">
        ...
        <div className="hashtags">
            <span className="hashtag">#GreenSmoothies</span>
            <span className="hashtag">#Detox</span>
            <span className="hashtag">#alexelcapo</span>
        </div>
    </section>
  )
}
