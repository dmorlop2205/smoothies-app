...
The project includes a comprehensive 22-page technical documentation detailing:
...
To test the **Marketplace**, you need the Stripe CLI:
1. `stripe login`
2. `stripe listen --forward-to localhost:8000/api/stripe/webhook`
3. Copy the resulting `whsec_...` to your `.env` in `STRIPE_WEBHOOK_SECRET`.